  ...
  return (
    <div name='home' className=' w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#8892b0] py-max-w-[700px]'>I'm a junior software devoloper with experience across multiple 
                ...
                transitioning into the industry, and finding my first fullstack or 
